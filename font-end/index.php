  ...
  <body>
    ...
    <div class="main-banner header-text" id="top">
        <div class="Modern-Slider">
          ...
          <?php
          require_once '../db.php';
          $get_banner_query= "SELECT * FROM banners WHERE active_status = 1  LIMIT 2";
          $bannners_from_db = mysqli_query($db_connect,$get_banner_query);
          foreach($bannners_from_db as $banner):
          ?>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <?php if(isset($_SESSION['guest_message_done'])):  ?>
                                        <small class="text-success"><?=$_SESSION['guest_message_done']?></small>
              ...
              <form id="contact" action="../admin/guest_message_post.php" method="post">
                <div class="row">
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_name" type="text" placeholder="Type your name" id="name"  class="form-control">
                    </fieldset>
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_email" type="email"  placeholder="Type your email" id="email"  class="form-control">
                    </fieldset>
                  ...
                  <div class="col-lg-4 col-md-12 col-sm-12">
                    <fieldset>
                      <input name="guest_subject" type="text"  placeholder="Type your Subject" id="subject"  class="form-control">
                    </fieldset>
                  ...
                  <div class="col-lg-12">
                    <fieldset>
                      <textarea name="guest_meassage"  placeholder="Type your Message" rows="6" class="form-control" id="message"></textarea>
                    </fieldset>
